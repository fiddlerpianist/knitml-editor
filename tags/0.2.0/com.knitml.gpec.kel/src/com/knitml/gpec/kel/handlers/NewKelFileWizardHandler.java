package com.knitml.gpec.kel.handlers;
...
import com.knitml.gpec.kel.wizards.KnittingElWizard;
 ...
 */
public class NewKelFileWizardHandler extends AbstractHandler {
	/**
	 * The constructor.
	 */
	public NewKelFileWizardHandler() {
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		IWizardDescriptor wizardDescriptor = wizardRegistry
				.findWizard(KnittingElWizard.ID);
		if (wizardDescriptor == null) {
			throw new ExecutionException(
					"unable to instantiate a KnittingElWizard because its ID was not found");
		}
