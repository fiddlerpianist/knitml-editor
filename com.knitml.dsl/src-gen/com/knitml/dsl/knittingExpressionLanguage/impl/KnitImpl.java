...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Knit</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.knitml.dsl.knittingExpressionLanguage.impl.KnitImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link com.knitml.dsl.knittingExpressionLanguage.impl.KnitImpl#isTogether <em>Together</em>}</li>
 *   <li>{@link com.knitml.dsl.knittingExpressionLanguage.impl.KnitImpl#isThroughTrailingLoop <em>Through Trailing Loop</em>}</li>
 *   <li>{@link com.knitml.dsl.knittingExpressionLanguage.impl.KnitImpl#getYarnRef <em>Yarn Ref</em>}</li>
 *   <li>{@link com.knitml.dsl.knittingExpressionLanguage.impl.KnitImpl#getRepeat <em>Repeat</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class KnitImpl extends InlineOperationImpl implements Knit
{
  /**
  ...
  {
    return KnittingExpressionLanguagePackage.Literals.KNIT;
  }
  ...
  public void setNumber(Integer newNumber)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KnittingExpressionLanguagePackage.KNIT__NUMBER, oldNumber, number));
  }
  ...
  public void setTogether(boolean newTogether)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KnittingExpressionLanguagePackage.KNIT__TOGETHER, oldTogether, together));
  }
  ...
  public void setThroughTrailingLoop(boolean newThroughTrailingLoop)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KnittingExpressionLanguagePackage.KNIT__THROUGH_TRAILING_LOOP, oldThroughTrailingLoop, throughTrailingLoop));
  }
  ...
  public void setYarnRef(String newYarnRef)
  {
    ...
    yarnRef = newYarnRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KnittingExpressionLanguagePackage.KNIT__YARN_REF, oldYarnRef, yarnRef));
  }
  ...
  public NotificationChain basicSetRepeat(RepeatSpec newRepeat, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KnittingExpressionLanguagePackage.KNIT__REPEAT, oldRepeat, newRepeat);
  ...
  public void setRepeat(RepeatSpec newRepeat)
  {
    if (newRepeat != repeat)
    {
      ...
      if (repeat != null)
        msgs = ((InternalEObject)repeat).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KnittingExpressionLanguagePackage.KNIT__REPEAT, null, msgs);
      if (newRepeat != null)
        msgs = ((InternalEObject)newRepeat).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KnittingExpressionLanguagePackage.KNIT__REPEAT, null, msgs);
      msgs = basicSetRepeat(newRepeat, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KnittingExpressionLanguagePackage.KNIT__REPEAT, newRepeat, newRepeat));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KnittingExpressionLanguagePackage.KNIT__REPEAT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KnittingExpressionLanguagePackage.KNIT__NUMBER:
        return getNumber();
      case KnittingExpressionLanguagePackage.KNIT__TOGETHER:
        return isTogether();
      case KnittingExpressionLanguagePackage.KNIT__THROUGH_TRAILING_LOOP:
        return isThroughTrailingLoop();
      case KnittingExpressionLanguagePackage.KNIT__YARN_REF:
        return getYarnRef();
      case KnittingExpressionLanguagePackage.KNIT__REPEAT:
        return getRepeat();
    }
